...
function f1() {
    document.getElementById("line1frame").style.animationPlayState = "running";
    document.getElementById("line2frame").style.animationPlayState = "running";
    document.getElementById("line3frame").style.animationPlayState = "running";
    document.getElementById("line4frame").style.animationPlayState = "running";
